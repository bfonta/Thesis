...
The analysis uses \SI{138}{\invfb} of data collected at $\sqrt{s}=13\,\si{\TeV}$ with a \SI{25}{\nano\second} bunch crossing intervals during 2016, 2017 and 2018 at \ac{CMS}, corresponding to \run{2}.
...
This can be observed in the $\tau\tau$ mass regression described in [[#sec:tautau_regression]].
