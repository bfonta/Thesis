...
The majority of studies involving the \ac{SM} Higgs boson or \ac{BSM} particles considers the \ac{NWA}, which equates to setting the particle's width $\Gamma$ to zero or to an arbitrarily small value.
...
The most up-to-date measurements of the Higgs boson's width are performed with the \hzzfourl{} and \hgg{} high resolution channels [[cite:&higgs_width_cms]].
