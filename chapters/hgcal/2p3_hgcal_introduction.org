...
In summary, while sustaining the doses and fluences shown in [[fig:dose_fluence_hgcal]], the \ac{HGCAL} fulfils the following requirements for its upgrade [[cite:&hgcalTDR]]:
