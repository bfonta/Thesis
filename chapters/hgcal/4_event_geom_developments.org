...
\noindent The \ac{Si} region is characterised by hexagonal-shaped modules and detector cells.
...
\noindent The regions in the detector covered by scintillator material follow a simpler polar-like coordinate system, defined in terms of \ac{eta} and \ac{phi} rings in the transversal plane.
