...
The role of the HGCAL TPG system is to build objects that are used as primitives by the
central L1 trigger.
...
+ mention briefly the updates at the level of the HLT for Phase-2
