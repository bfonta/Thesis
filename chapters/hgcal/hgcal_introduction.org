...
In summary, \ac{HGCAL} fulfils many of the requirements imposed by the \ac{HL-LHC} [[cite:&hgcalTDR]]:
...
#+CAPTION: Summary of some of properties of \ac{HGCAL}.
