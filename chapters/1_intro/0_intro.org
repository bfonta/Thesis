...
And yet, we know the \ac{SM} to be incomplete, from the surprising behavior of rotation curves of galaxies, to a mysterious form of energy permeating the entire Universe, or the apparent absence of a charge-mirrored world.
...
While some of these properties still remain under-constrained by the experiments, none of the highly anticipated new resonances have been discovered, such as the ones predicted by \ac{SUSY}.
