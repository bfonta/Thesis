...
This overarching theory is known as the \ac{SM} of Particle Physics, which serves as the foundation of modern \ac{HEP}.
...
Inconsistencies are elegantly solved with the Higgs mechanism, discussed in [[#sec:higgs_mechanism]]; a revolutionary idea defining the modern understanding of Particle Physics.
...
We finalize this first Section by presenting a concise account of the phenomenology and experimental status of single Higgs physics: the quantities worth measuring, and the results such measurements have so far yielded.
