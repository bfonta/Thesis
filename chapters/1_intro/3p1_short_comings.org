...
+ *\Ac{CP} violation and baryogenesis*:
  Sakharov identified three necessary ingredients to explain a process capable of reproducing the observed asymmetry: /i/) lepton and baryon number violation, /ii/) a Universe was out of thermal equilibrium at some point in time, and /iii/) a \ac{CP}-violating interaction.
