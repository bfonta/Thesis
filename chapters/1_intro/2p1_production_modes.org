...
The main differences consist of the larger number of possible Feynamn diagrams for each production mode at the lowest loop order, the connected multiplicity increase in the final state decay products, and the dramatic cross section reduction of 3 orders of magnitude.
...
Gluon fusion will nevertheless remain dominant in any future hadron collider as it is at the \ac{LHC}.
