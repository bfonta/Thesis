...
#+CAPTION: Comparison between data and \ac{MC} for the number of \acp{PV}, using 2017 \ac{UL} conditions. The \ac{PV} multiplicity is very sensitive to \ac{PU}. Produced in the context of \newcite{analysis_pu_reweighting}, featuring \zmumu{} events. Courtesy of Pedro Silva.
#+BEGIN_figure
\centering
