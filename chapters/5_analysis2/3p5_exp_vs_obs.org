...
A potentially minor adjustement in the analysis' selection, or a slight change in the training of the final discriminant, for instance, might very well modify the test statistic, and thus affect the final upper limits.
...
This might in turn lead to the appearance of spurious excesses, like the $\gamma\gamma$ bump seen in 2015 at \SI{750}{\GeV}.
...
Given the timeline of our analysis, in the next Section we present expected \xhhbbtt{} upper limits.
