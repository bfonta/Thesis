...
It follows a short description of the Neyman-Pearson Lemma in [[#sec:lemma]] which, together, with the concept of likelihood maximization described in [[#sec:likelihood]], forms the basis of the definition of the test statistics used in \ac{HEP}, and which is described in [[#sec:cls]].
We conclude by explaining in [[#sec:exp_vs_obs]] why the most sensitive data region is not analyzed until well into the final stages of a \ac{HEP} study.
