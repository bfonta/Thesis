...
We then proceed, in [[#sec:systematics]], with a description of all systematic uncertainties taken into account, both arising from variations to the inputs of the \ac{DL} procedure, and also to shifts to the several \ac{MC} correction weights taken into account in our analysis.
