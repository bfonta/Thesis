...
The local p-value is thus converted into a global one through a new test statistic, computed by taking the maximum value of test statistics over the hypothese's domain [[cite:&stat_procedure_comb_higgs]]:
