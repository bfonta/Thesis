...
Systematic uncertainties affecting only the yield of a given signal or background process are detailed in [[#sec:syst_norm]], and systematics also affecting the shape of the final discriminant variable are listed in [[#sec:syst_shape]].
