...
Similarly to other \ac{HEP} experiments, \ac{CMS} consists of consecutive barrel and endcap detector layers surrounding the \ac{pp} \ac{IP}.
...
** PF Tracks
Reconstructing charged particles consists in recreating their trajectories from individual hits, and extracting particle properties from those trajectories.
