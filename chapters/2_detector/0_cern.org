...
The tunnel is located at a depth ranging between \num{45} and \SI{170}{\meter}, and was formerly used by \ac{LHC}'s predecessor, LEP, connected to the precise measurements of the mass of the W and Z bosons, among other parameters.
...
One of such machines is known as CMS, and represents the general particle physics experiment producing the data which serves as basis for the thesis you are now reading.

This Chapter provides a condensed summary of the elements and ideas behing the data production flow taking place at the \ac{LHC} and \ac{CMS}, from circulating proton bunches to the definition of measured physics objects, as used to extend the current knowledge on subatomic physics.
...
We finalize the Chapter by discussing Monte Carlo generation within \ac{CMS}, also in light of the Monte Carlo activities developed within the timeframe of the thesis here reported.
