...
In this section we provide a brief overview of a general method for estimating \acp{SF} of the \logicor{} of any number of triggers.
...
The method just presented was not applied to the \xhhbbtt{} analysis, despite being fully implemented and despite the preliminary validation.
