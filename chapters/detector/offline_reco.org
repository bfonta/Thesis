...
As a consequence, once a hard collision in \ac{HEP} experiments takes place, ejected quarks and gluons are immediately associated to other colored objects, forming colorless hadrons in a process called /hadronisation/.
