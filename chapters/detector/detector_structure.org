...
+ *Gas Electron Multipliers*:
  ...
  Each \ac{GEM} chamber includes a stack of three \ac{GEM} foils, which consist of a \SI{50}{\micro\meter}-thick insulating polymer covered on both sides by thin copper conductive layers.
