...
And yet we know it to be incomplete, from the surprising behaviour of rotation curves of galaxies, to a mysterious form of energy which permeates the entire Universe, to the apparent absence of a charge-mirrored world which should naively exist in identical proportions to our own.
...
The first section sets the tone with a brief historical introduction, and the text quickly moves on to detail the theoretical building blocks of Particle Physics, before describing the Higgs mechanism, one of the main ideas which revolutionized our understanding of fundamental interactions.
