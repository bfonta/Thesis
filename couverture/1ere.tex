...
\newcommand{\PhDTitle}{Search for resonant Higgs boson pair production in the bb$\uptau\uptau$ decay channel and developments in the reconstruction of High Granularity Calorimeter trigger primitives with the CMS detector at the LHC} 	%% Titre de la thèse / Thesis title
\newcommand{\PhDname}{Bruno Afonso Fontana Santos Alves} 															%% Civilité, nom et prénom /  Civility, first name and name 
\newcommand{\NNT}{2024IPPAX098} 															%% Numéro National de Thèse (donnée par la bibliothèque à la suite du 1er dépôt)/ National Thesis Number (given by the Library after the first deposit)
...
%% 	\includegraphics[scale=1]{~/org/PhD/Thesis/figures/extra/etab/\logoEtt.png} 
%% \end{textblock}

\begin{textblock}{1}(\hpos,\vpos)
	\textblockcolour{white}
	\includegraphics[scale=1]{~/org/PhD/Thesis/figures/extra/etab/X.png}
\end{textblock}

\begin{textblock}{10.45}(5.3,3)
	\textblockcolour{white}
