...
\label{sec:org94bac0b}
\subsection{The Standard Model of Particle Physics}
\label{sec:orgd10bb18}
\label{sec:SM}
\subsubsection{Brief historical perspective}
\label{sec:org409a16c}
\subsubsection{The building blocks of the SM}
\label{sec:org31c7d57}
\subsubsection{The Higgs Mechanism}
\label{sec:org03f6d8b}
...
\label{sec:orge8a9a93}
\begin{enumerate}
\item The \zzzhbbbb{} analysis
\label{sec:org1867263}
...
\label{sec:orgb53807f}
\subsubsection{SM shortcomings}
\label{sec:org8d72ead}
...
\label{sec:org26924a7}
\subsection{The Large Hadron Collider}
\label{sec:orga35f91c}
\label{sec:lhc_intro}
...
\label{sec:orga71ee25}
\begin{enumerate}
\item Data processing chain
\label{sec:orgbcdb8fe}
\begin{itemize}
...
\label{sec:orgf8cddb7}
\label{sec::bbtautau}
\subsection{Data, MC and signal samples}
\label{sec:orgba6981f}

\subsection{Triggers}
\label{sec:orgb268c6e}
\subsubsection{Legacy triggers}
\label{sec:org19046d9}
\subsubsection{Additional triggers}
\label{sec:org5319f7a}
\subsubsection{Analysis trigger regions}
\label{sec:org1098b74}
\subsubsection{Note on the inclusion method}
\label{sec:org8327505}
\subsection{Physics objects}
\label{sec:orgfef7f0a}
\subsubsection{Electrons}
\label{sec:org45d18e8}
\subsubsection{Muons}
\label{sec:org8f3e477}
\subsubsection{Hadronic \(\tau\)'s}
\label{sec:org53c890c}
\subsubsection{Jets}
\label{sec:orgd95f389}
\begin{enumerate}
\item b-jets
\label{sec:org04df8ea}
\end{enumerate}
\subsubsection{Missing transverse energy}
\label{sec:orga23398c}
\subsection{Selection}
\label{sec:orgf715f56}
\subsubsection{\(\tau \tau\) pair}
\label{sec:org3476bd0}
\subsubsection{bb pair}
\label{sec:orgc6a8597}
\begin{enumerate}
\item HH b-tagging network
\label{sec:org4ae1ce4}
\end{enumerate}
\subsection{Categorization}
\label{sec:org350c51e}
\subsubsection{Resolved jets}
\label{sec:org5855a12}
\subsubsection{Boosted jets}
\label{sec:org3f0c3f5}
\subsection{\(\tau \tau\) mass regression}
\label{sec:org290f74c}
\subsection{QCD background estimation}
\label{sec:orgb7c0ee4}
\subsubsection{Validation}
\label{sec:org5ebdd79}
\begin{itemize}
...
\label{sec:orga67b824}
\subsubsection{Pileup reweighting}
\label{sec:orgd3c4944}
\subsubsection{Pileup jet identification}
\label{sec:org7949fe6}
...
\label{sec:org95a14e1}
\subsubsection{Lepton scale factors}
\label{sec:org3edbb10}

\subsection{Control regions}
\label{sec:org028cc66}
