...
\label{sec:org631202d}
\label{sec:lhc_operatoins}
\subsubsection{Experiments}
\label{sec:orgb21d827}
...
\label{sec:org38b3548}
\begin{enumerate}
\item Data processing chain
\label{sec:org1e72fa7}
\begin{itemize}
...
\label{sec:org30f0e62}
\label{sec::bbtautau}
\subsection{Data, MC and signal samples}
\label{sec:org24ab229}

\subsection{Triggers}
\label{sec:org38af26e}
\subsubsection{Legacy triggers}
\label{sec:orgf6d1de2}
\subsubsection{Additional triggers}
\label{sec:org63f921a}
\subsubsection{Analysis trigger regions}
\label{sec:org73757a9}
\subsubsection{Note on the inclusion method}
\label{sec:org9e3cb9d}
\subsection{Physics objects}
\label{sec:orgf27be0e}
\subsubsection{Electrons}
\label{sec:orgcdf220e}
\subsubsection{Muons}
\label{sec:orge1c6d99}
\subsubsection{Hadronic \(\tau\)'s}
\label{sec:orgb105521}
\subsubsection{Jets}
\label{sec:org37e8175}
\begin{enumerate}
\item b-jets
\label{sec:orgd20f72a}
\end{enumerate}
\subsubsection{Missing transverse energy}
\label{sec:orgb0888bc}
\subsection{Selection}
\label{sec:org19d9d48}
\subsubsection{\(\tau \tau\) pair}
\label{sec:org42b25d0}
\subsubsection{bb pair}
\label{sec:org065c829}
\begin{enumerate}
\item HH b-tagging network
\label{sec:org6f744f2}
\end{enumerate}
\subsection{Categorization}
\label{sec:org332951f}
\subsubsection{Resolved jets}
\label{sec:org38b1dd3}
\subsubsection{Boosted jets}
\label{sec:orgd75e206}
\subsection{\(\tau \tau\) mass regression}
\label{sec:org802480a}
\subsection{QCD background estimation}
\label{sec:orge21eccc}
\subsubsection{Validation}
\label{sec:org5ce48c8}
\begin{itemize}
...
\label{sec:orgc1263f1}
\subsubsection{Pileup reweighting}
\label{sec:org6749aca}
\subsubsection{Pileup jet identification}
\label{sec:orgb6314cb}
...
\label{sec:org956ed87}
\subsection{Results}
\label{sec:org1dc0b90}
\subsubsection{Final limits}
\label{sec:orga9ccc35}
