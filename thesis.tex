...
\label{sec:org2e0c3e9}
\subsection{The Standard Model of Particle Physics}
\label{sec:orgb68d85a}
\label{sec:SM}
\subsubsection{Brief historical perspective}
\label{sec:org8e5c20b}
\subsubsection{The building blocks of the SM}
\label{sec:orgcdac79f}
\subsubsection{The Higgs Mechanism}
\label{sec:org93d1ef0}
...
\subsubsection{4b}
\label{sec:orga574a12}
\label{sec:bbbb}
\subsubsection{bb\(\gamma \gamma\)}
\label{sec:org0812f5e}
\label{sec::bbgg}
\subsubsection{bb\(\tau \tau\)}
\label{sec:org2ee70c7}
\label{sec::bbtautau}
...
\label{sec:orgd43b00c}
\begin{enumerate}
\item The \zzzhbbbb{} analysis
\label{sec:org198fad7}
...
\label{sec:org64dd0eb}
\subsubsection{SM shortcomings}
\label{sec:org3874c4e}
...
\label{sec:org266e104}
\subsubsection{Level-1}
\label{sec:org3bf05ee}
\subsubsection{HLT}
\label{sec:org72b8894}
\subsection{Offline identification and reconstruction of physics objects}
\label{sec:orge14d000}
\subsubsection{Particle-flow}
\label{sec:orgf9aa103}
\subsubsection{Electrons}
\label{sec:orgf834b20}
\subsubsection{Muons}
\label{sec:orga3b7dfa}
\subsubsection{Hadronic \(\tau\)'s}
\label{sec:org9378709}
\subsubsection{Jets}
\label{sec:orgb143630}
\subsubsection{Missing transverse energy}
\label{sec:org0545bc4}
\subsection{Monte Carlo generation}
\label{sec:orgb4b8a1a}
\begin{itemize}
...
\label{sec:org1ef681f}
\begin{enumerate}
\item Data processing chain
\label{sec:org5f7e997}
\begin{itemize}
...
\begin{itemize}
\item \texttt{MTD} \cite{mtd_tdr,mtd_timing_plot}
\item \ldots{}
\item \texttt{HGCAL} is detailed in the next section
\end{itemize}
...
\begin{figure}
\begin{center}
\includegraphics[width=.8\textwidth]{/home/bruno/org/PhD/Thesis/figures/hgcal/layer_structure.pdf}
\end{center}
...
\begin{figure}
\includegraphics[width=1.\textwidth]{/home/bruno/org/PhD/Thesis/figures/hgcal/LongitudinalStructure1.pdf}
\caption{\label{fig:hgcal_long_structure1}Illustration of the longitudinal structure of the \ac{Si}-only \ac{CE-H} (top) and \ac{CE-E} (bottom) sections. Each \ac{CE-E} unit comprises two sampling layers. The \ch{CuW} baseplate provides rigidity and cooling. The \ch{Pb}+\ac{SS} absorber in the last \ac{CE-E} cassette is replaced by a \SI{1}{\mm} \ch{Cu} cover. The components are not drawn to scale.}
\end{figure}
...
\begin{figure}
\includegraphics[width=.9\textwidth]{/home/bruno/org/PhD/Thesis/figures/hgcal/LongitudinalStructure2.pdf}
\caption{\label{fig:hgcal_long_structure2}Illustration of the longitudinal structure of the mixed \ac{CE-H} section. The \ch{CuW} baseplate provides rigidity and cooling. The \ac{Sci} cells nearer the beam line are significantly smaller than those at the outer edge. The tileboard includes the \acp{SiPM}. The silicon section is extremely similar to the one present in the \ac{CE-E} and \ac{Si} \ac{CE-H}. The components are not drawn to scale.}
\end{figure}
...
\end{center}
\begin{center}
\includegraphics[width=1.\textwidth]{/home/bruno/org/PhD/Thesis/figures/hgcal/FluenceHGCAL.pdf}
\end{center}
...
\begin{figure}
\includegraphics[width=1.02\textwidth]{/home/bruno/org/PhD/Thesis/figures/hgcal/stage2chain.pdf}
...
\begin{figure}
\includegraphics[width=.8\textwidth]{/home/bruno/org/PhD/Thesis/figures/analysis1/TauDMs.pdf}
