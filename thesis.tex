...
\label{sec:orgea2f5be}
\begin{enumerate}
\item The \zzzhbbbb{} analysis
\label{sec:orgcd63449}
...
\label{sec:org3b6969a}
\label{sec:lhc_operatoins}
\subsubsection{Experiments}
\label{sec:org7224d2f}
...
\label{sec:org65e6e76}
\begin{enumerate}
\item Data processing chain
\label{sec:org4ba2541}
\begin{itemize}
...
\label{sec:org68979df}
\label{sec::bbtautau}
\subsection{Data, MC and signal samples}
\label{sec:orgf83ad01}

\subsection{Triggers}
\label{sec:org4cf5161}
\subsubsection{Legacy triggers}
\label{sec:orga1333eb}
\subsubsection{Additional triggers}
\label{sec:org866aec2}
\subsubsection{Analysis trigger regions}
\label{sec:org8014eb1}
\subsubsection{Note on the inclusion method}
\label{sec:org1e1cef9}
\subsection{Physics objects}
\label{sec:org2be9257}
\subsubsection{Electrons}
\label{sec:org30a3330}
\subsubsection{Muons}
\label{sec:orgd0ac68d}
\subsubsection{Hadronic \(\tau\)'s}
\label{sec:orgcd221f1}
\subsubsection{Jets}
\label{sec:orgb92323c}
\begin{enumerate}
\item b-jets
\label{sec:orgdc38adc}
\end{enumerate}
\subsubsection{Missing transverse energy}
\label{sec:orgf699723}
\subsection{Selection}
\label{sec:org3f7d248}
\subsubsection{\(\tau \tau\) pair}
\label{sec:org93ebee1}
\subsubsection{bb pair}
\label{sec:orgd95615f}
\begin{enumerate}
\item HH b-tagging network
\label{sec:orgfd7987b}
\end{enumerate}
\subsection{Categorization}
\label{sec:org9c78e93}
\subsubsection{Resolved jets}
\label{sec:org14461f0}
\subsubsection{Boosted jets}
\label{sec:org718eb74}
\subsection{\(\tau \tau\) mass regression}
\label{sec:orgadb1034}
\subsection{QCD background estimation}
\label{sec:org9b561bc}
\subsubsection{Validation}
\label{sec:orgb75e123}
\begin{itemize}
...
\label{sec:org4c7b009}
\subsubsection{Pileup reweighting}
\label{sec:org8206f70}
\subsubsection{Pileup jet identification}
\label{sec:org4bca3db}
...
\label{sec:org764c870}


\section{List of acronyms}
\label{sec:org94f4ea5}
\input{acro_list}
