...
\label{sec:org834254c}
\subsection{The Standard Model of Particle Physics}
\label{sec:org06d5155}
\label{sec:SM}
\subsubsection{Brief historical perspective}
\label{sec:orgb58a9d9}
\subsubsection{The building blocks of the SM}
\label{sec:org6570dae}
\subsubsection{The Higgs Mechanism}
\label{sec:org9ca32d5}
...
\subsubsection{To do :noexport: [0/1]}
\label{sec:orgb4ab111}
\begin{itemize}
\item[{$\square$}] cover \cite{hllhc_physics} physics briefly discussed in \cref{sec:hllhc}
\end{itemize}

\subsubsection{Production}
\label{sec:org81adfd7}
...
\label{sec:org5078b26}
\begin{enumerate}
\item The \zzzhbbbb{} analysis
\label{sec:orgbd57f7b}
...
\begin{figure}[htbp]
\centering
\includegraphics[width=.8\textwidth]{/home/bruno/org/PhD/Thesis/figures/limits_HH_SM_Mar2023.pdf}
...
\begin{figure}[htbp]
\centering
\includegraphics[width=.85\textwidth]{/home/bruno/org/PhD/Thesis/figures/exclusion_kl_Mar2023.pdf}
...
\begin{figure}[htbp]
\centering
\includegraphics[width=.85\textwidth]{/home/bruno/org/PhD/Thesis/figures/exclusion_C2V_Mar2023.pdf}
...
\begin{figure}[htbp]
\centering
\includegraphics[width=.9\textwidth]{/home/bruno/org/PhD/Thesis/figures/scan_kl_nature.pdf}
...
\begin{figure}[htbp]
\centering
\includegraphics[width=.9\textwidth]{/home/bruno/org/PhD/Thesis/figures/scan_k2v_nature.pdf}
...
\label{sec:org048a53a}
\subsubsection{SM shortcomings}
\label{sec:org2db339b}
...
\label{sec:orgb012635}
\label{sec:lhc_operatoins}
\subsubsection{Experiments}
\label{sec:orgc72aa76}
\label{sec:lhc_experiments}
\subsection{The CMS Detector}
\label{sec:orgeffff56}
...
\label{sec:orge14a563}
\subsubsection{Level-1}
\label{sec:org2f7e56d}
\subsubsection{HLT}
\label{sec:orgb961b5d}

\subsection{Offline iddentification and reconstruction of physics objects}
\label{sec:orge95a7a7}
\subsubsection{Particle-flow}
\label{sec:orgfa7afbf}
\subsubsection{Electrons}
\label{sec:orgc44880b}
\subsubsection{Muons}
\label{sec:org10b7f02}
\subsubsection{Hadronic \(\tau\)'s}
\label{sec:org851933e}
\subsubsection{Jets}
\label{sec:org04470e0}
\subsubsection{Missing transverse energy}
\label{sec:org1bcd6f3}
\subsection{Monte Carlo generation}
\label{sec:org711d219}
\begin{itemize}
...
\label{sec:org91a9c4a}
\begin{enumerate}
\item Data processing chain
\label{sec:org9d7f49b}
\begin{itemize}
...
\label{sec:org9fbb521}
\label{sec::bbtautau}
\subsection{Data, MC and signal samples}
\label{sec:orgc73dcc1}

\subsection{Triggers}
\label{sec:org134e592}
\subsubsection{Legacy triggers}
\label{sec:orgfab7b6d}
\subsubsection{Additional triggers}
\label{sec:org065a583}
\subsubsection{Analysis trigger regions}
\label{sec:orgde8a4a3}
\subsubsection{Note on the inclusion method}
\label{sec:org00943d0}
\subsection{Physics objects}
\label{sec:orgbcdc02f}
\subsubsection{Electrons}
\label{sec:orgccf0104}
\subsubsection{Muons}
\label{sec:org9556897}
\subsubsection{Hadronic \(\tau\)'s}
\label{sec:org201ff68}
\subsubsection{Jets}
\label{sec:org9f1bb62}
\begin{enumerate}
\item b-jets
\label{sec:org3dcc1d9}
\end{enumerate}
\subsubsection{Missing transverse energy}
\label{sec:org2f9056a}
\subsection{Selection}
\label{sec:orgfc48d86}
\subsubsection{\(\tau \tau\) pair}
\label{sec:orgf860f58}
\subsubsection{bb pair}
\label{sec:orgbd9747f}
\begin{enumerate}
\item HH b-tagging network
\label{sec:org0c1f86f}
\end{enumerate}
\subsection{Categorization}
\label{sec:org317bdea}
\subsubsection{Resolved jets}
\label{sec:orgc6e1728}
\subsubsection{Boosted jets}
\label{sec:orgc0b11b2}
\subsection{\(\tau \tau\) mass regression}
\label{sec:org5e22676}
\subsection{QCD background estimation}
\label{sec:org53c886e}
\subsubsection{Validation}
\label{sec:orgf9bff18}
\begin{itemize}
...
\subsubsection{Run3}
\label{sec:org491265c}
\begin{itemize}
\item mention \reshybbtt{} analysis
\end{itemize}
\subsubsection{HL-LHC}
\label{sec:org69536b7}
\begin{itemize}
\item mention \reshybbtt{} analysis
\end{itemize}
\subsubsection{Future accelerators}
\label{sec:org7e8e99b}
\begin{itemize}
\item mention \reshybbtt{} analysis
\end{itemize}

\section{Effects of finite width and interference in resonant HH production}
\label{sec:orgc58f749}
\subsection{The Singlet Model}
\label{sec:orgcb8b2c1}
\label{sec::SingletModel}

This is the singlet model \cite{jona_soutenance} and \cite{hgcal_tdr}.
\subsection{Methodology}
\label{sec:orgd42ed59}
\subsection{Results}
\label{sec:org8184520}


\section{Conclusions}
\label{sec:org68f79ce}


\section{Appendix}
\label{sec:org4884a2b}
\subsection{General control distributions}
\label{sec:org468bbe3}
\subsection{MET SF control distributions}
\label{sec:org1c24eea}


\section{List of acronyms}
\label{sec:org03cb61f}
\input{acro_list}

\bibliographystyle{unsrt}
\bibliography{../../../dot-emacs/bibliography/references/higgs,../../../dot-emacs/bibliography/references/l1,../../../dot-emacs/bibliography/references/mc_generation,../../../dot-emacs/bibliography/references/pure_software,../../../dot-emacs/bibliography/references/detector}
\end{document}
