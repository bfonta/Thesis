...
# ##### PhD Structure
#+LATEX_HEADER: \newcommand{\PhDTitle}{Search for resonant Higgs boson pair production in the bb$\tau\tau$ decay channel and developments in the reconstruction of High Granularity Calorimeter trigger primitives with the CMS detector at the LHC}
